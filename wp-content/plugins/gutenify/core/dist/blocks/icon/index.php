 ...
 */
function gutenify_load_textdomain_block_icon() {
	load_plugin_textdomain( 'gutenify', false, basename( __DIR__ ) . '/languages' );
}
add_action( 'init', 'gutenify_load_textdomain_block_icon' );
...
function gutenify_register_block_icon() {
	...
	if ( function_exists( 'wp_set_script_translations' ) ) {
		 ...
		 */
		wp_set_script_translations( 'gutenify-block-icon', 'gutenify' );
	}
}
